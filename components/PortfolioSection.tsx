    ...
    <section className="py-20 bg-aiwis-dark overflow-hidden">
      ...
      <div className="relative w-full">
        <div className="flex overflow-x-auto gap-4 px-6 pb-8 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          ...
          <div className="flex-none w-72 md:w-96 snap-center flex items-center justify-center border-2 border-dashed border-slate-800 rounded-lg hover:border-slate-600 transition-colors cursor-pointer group bg-slate-900/30">
